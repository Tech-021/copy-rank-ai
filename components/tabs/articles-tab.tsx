                      ...
                      <DialogContent className="sm:max-w-[900px] max-h-[90vh] overflow-y-auto p-0">
                        <div className="p-6">
                          ...
                          <div className="space-y-6">
                            ...
                            {/* Article Content Section with expandable body */}
                            <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                              <div className="p-6">
                                <div
                                  className={`prose prose-sm sm:prose-base lg:prose-lg max-w-none relative ${
                                    isContentExpanded ? "" : "max-h-[420px] overflow-hidden"
                                  }`}
                                >
