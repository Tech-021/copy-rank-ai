            ...
            <tbody className="border border-[#53f8701a]">
              {filteredAndSortedKeywords.length > 0 ? (
                filteredAndSortedKeywords.map((kw, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 text-[#53f870] py-3 text-sm font-medium">
                        {kw.keyword}
                      </td>
                      <td className="px-6 text-[#fffffb3] py-3 text-sm">
                      ...
                      <td className="px-6 py-3">
                        <span
                          className={`inline-flex items-center px-2.5 py-1 text-xs font-medium border rounded ${getPostStatusColor(
                            kw.post_status
                          )}`}
                        >
                      ...
                      <td className="px-6 py-3">
                        <div className="flex items-center justify-start gap-0">
                          <Button className="border w-[114px] border-[#53f8701a] rounded-r-none bg-transparent text-[#ffffffb3] hover:text-[#53f870] hover:!bg-[#53f8701a] cursor-pointer border-r-0 px-4 h-8 text-xs font-medium">
                            Edit
                          </Button>
                          <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                              <Button className="group border border-[#53f8701a] rounded-l-none bg-transparent hover:!bg-[#53f8701a]  focus-visible:outline-none cursor-pointer w-8 h-8 p-0 flex items-center justify-center">
                                <ChevronDown className="w-4 h-4 text-[#ffffffb3] group-hover:text-[#53f870]  transition-colors duration-200" />
                              </Button>
                            </DropdownMenuTrigger>
                            <DropdownMenuContent
                              align="end"
                              className="w-36 border bg-[#101110] border-[#53f8701a]"
                            >
                              <DropdownMenuItem
                                onClick={() => handleDeleteKeyword(index)}
                                className="text-red-600 hover:text-red-600! hover:bg-transparent! focus-visible:bg-transparent! px-10 text-center cursor-pointer"
                              >
                                Delete
                              </DropdownMenuItem>
                            </DropdownMenuContent>
                ...
                <tr>
                  <td
                    colSpan={8}
                    className="px-6 py-8 text-center text-sm text-[#ffffffb3]"
                  >
