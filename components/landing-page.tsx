      ...
      <nav className="border-b border-border/40 backdrop-blur-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              onClick={onSignUp}
              className="cursor-pointer bg-blue-700 hover:bg-blue-700 text-primary-foreground rounded-full shadow-[inset_0_0_4px_2px_rgba(255,255,255,0.28),0_0_8px_1px_rgba(36,101,255,0.4)] opacity-100 will-change-auto hover:bg-blue-700 transition text-sm"
            >
              Sign Up
            </Button>
            ...
            <Dialog>
              <DialogTrigger asChild>
                <Button className="cursor-pointer bg-green-600 hover:bg-green-700 text-white rounded-full text-sm transition">
                  Open Dialog
                </Button>
              </DialogTrigger>
              ...
              <DialogContent className="max-w-lg p-0 overflow-hidden rounded-xl shadow-lg border border-border/50 bg-white">
                <div className="px-10 py-8">
                  ...
                  <div className="space-y-6">
                    <div className="space-y-2">
                      <div className="border">
                       <Label className="text-xs text-gray-600 ml-2">Are you already selling?</Label>
                      <Select>
                      
                        <SelectTrigger className="w-full  ">
                          <SelectValue className="" placeholder="Please choose one..." />
                    ...
                    <div className="space-y-2">
                      <div className="border">
                      <Label className="text-xs text-gray-600 ml-2">What is your current revenue?</Label>
                      <Select>
                        <SelectTrigger className="w-full border-gray-300 focus:ring-0 focus-visible:ring-0 focus:outline-none">
                  ...
                  <div className="flex justify-end mt-8">
                    <Button className="px-6 bg-[#4a5fd8] hover:bg-[#3d52c7] text-white rounded-md shadow-sm">
                      Next
                    </Button>
                  </div>
                </div>
